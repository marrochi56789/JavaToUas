    ...
    <center><h1>SURAT JALAN</h1></center>
        <table cellpadding="0" cellspacing="0">
            <tr class="top">
                <td colspan="5">
                    <table>
                        <tr>
                            <td class="title">
                                <p style="font-size: 20px;">LIMBAH DESA (LIMDES)
                            </td>
                ...
                <td colspan="5">
                    <table>
                        <tr>
                            <td>
                                Jalan Kenangan<br>
                                Kp.Kerinduan Ds.Kebahagian<br>
                                Kec.Selamat Dunia Akhirat
                            </td>
                            
                            <td>
                                Instagram@marrochi12345<br>
                                wwww.&copy;oci.com&trade;<br>
                                marrochi12345@gmail.com
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="item">
                ...
                <td>RP,- <?php echo number_format($r['hsatuan']) ?></td>
                <td><?php echo $r['jumlah_beli'] ?> Kg</td>
            ...
            <tr class="total">
                ...
                ?>
                <td>RP,- <?php echo number_format($bayar['bayar']) ?></td>
            </tr>
            <tr class="total">
                <td></td>
                <td></td>
                ...
                ?>
                <td><hr>RP,- <?php echo number_format($kembalian['kembalian']); ?><hr></td>
            </tr>
        </table>
        <hr>
        <h3>Terimkasih jangan lupa kesini lagi iya !!</h3>
    </div>
</body>
</html>
